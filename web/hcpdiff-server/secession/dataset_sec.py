...
class DatasetSecession:
    ...
    def _create_dataset(self, pretrained_model, prompt_file: str, negative_prompt: str, out_dir: str, bs: int, num: int):
        ds_creator = DatasetCreator(pretrained_model, out_dir)
        ds_creator.create_from_prompt_dataset(prompt_file, negative_prompt, bs, num, callback=self.progress_callback)
